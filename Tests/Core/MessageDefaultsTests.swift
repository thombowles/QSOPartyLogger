...
final class MessageDefaultsTests: XCTestCase {
    ...
    static let rstPartyIDs = [
        "alqp", "arqp", "azqp", "bcqp", "coqp", "deqp", "fqp", "gaqp", "hqp", "iaqp", "ilqp", "inqp", "ksqp", "kyqp", "laqp", "meqp", "miqp", "moqp", "msqp", "ndqp", "neqp", "newenglandqp", "nmqp",
    ...
    func testEveryReportPartyKeepsTheShippedDefaults() throws {
        XCTAssertEqual(Self.rstPartyIDs.count, 37,
