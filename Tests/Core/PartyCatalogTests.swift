...
final class PartyCatalogTests: XCTestCase {
    ...
    func testBundledPartiesLoad() throws {
        ...
        XCTAssertEqual(
            ...
            ["alqp", "azqp", "bcqp", "coqp", "cqp", "gaqp", "hqp", "iaqp", "idqp", "ilqp", "ksqp", "mdc",
             "meqp", "miqp",
             "laqp", "mnqp", "moqp", "msqp", "ncqp", "ndqp", "nhqp", "nmqp", "njqp", "nyqp", "ohqp", "okqp", "oqp", "paqp", "qcqp", "scqp", "sdqp", "tnqp", "tqp", "vaqp", "vtqp",
             "warun", "wiqp"]
        )
    }
    ...
    func testPartialVerificationStatusPerParty() throws {
        let expectedPartial: Set<String> = [
            ...
            "wiqp", "vaqp", "laqp", "msqp", "moqp", "nmqp", "gaqp", "ndqp", "miqp", "oqp", "qcqp",
        ]
        for party in PartyCatalog.loadBundled() {
            XCTAssertEqual(
