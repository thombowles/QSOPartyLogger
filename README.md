...
used; the remaining two start from their sponsors' sites. Adding a party is governed by
...
(`brew install xcodegen`). 541 unit tests cover the scoring engine, county
