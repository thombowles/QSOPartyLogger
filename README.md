...
order — the season ends with Illinois on Oct 18. Three of them have full rules
research banked in `docs/research/` and three more have raw sponsor text
...
(`brew install xcodegen`). 267 unit tests cover the scoring engine, county
