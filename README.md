...
(`brew install xcodegen`). 1680 unit tests cover the scoring engine, county
...
- NAQP CW: rules from NCJ's own "Rules: 2026 North American QSO Party
  ...
  entity definitions — all fetched 2026-07-27. Countries generated from the
  committed checklist + ARRL texts by
  [`docs/research/gen_naqp.py`](docs/research/gen_naqp.py) — never hand-typed.
  Cabrillo header `NAQP-CW` from the WA7BNM registry (entry 218), the one
  value the sponsor does not print. **Not a State QSO Party Challenge
  contest**, by the Challenge's own approved list and KE5CW's requirement.
