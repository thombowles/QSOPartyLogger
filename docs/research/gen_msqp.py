...
msqp = {
    ...
    "notes": (
        ...
        "for. WORSE, A GRID SQUARE IS SILENTLY ACCEPTED AS A PHANTOM DX MULTIPLIER: because DX "
        "stations here send a country prefix, a token like EM42 looks like a valid prefix to this "
        "app, so a Mississippi entrant who logs one is credited a DXCC entity that does not "
        "exist. TAKEN WITH LIMITATION 1, FT4/8 CONTACTS ARE BEST KEPT OUT OF THIS LOG and scored by "
