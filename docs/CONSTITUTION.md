...
### Article 11 — Direct CW keying is the preferred path; voice comes from the radio
...
human voice better than the radio can. So for CW the radio's keyer is the
fallback, and for voice the radio's memories are the *only* path.
