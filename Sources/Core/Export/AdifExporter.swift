...
enum AdifExporter {
    ...
    /// so MY_SIG_INFO names that park alone — "A separate log must be
    ...
    /// Their parks still expand per record, so P2P credit survives the split.
    ...
    /// `@subdivision` rides after the date — `W8MSC@US-4239-20181231-US-MI.adi`
    /// is the page's own example, banked in docs/research/pota/SOURCES.md.
